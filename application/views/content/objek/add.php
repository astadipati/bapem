        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tambah Objek</h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <!-- konten dimari -->
                            <?php
                            echo form_open_multipart('objek/add', 'role="form" class="form-horizontal"');
                            ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="objek" placeholder="Objek" id="form-field-1" class="form-control">
                                </div> 
                                <label class="col-sm-8 control-label" for="form-field-1">
                                    Keterangan
                                </label>
